...
fetch('./people.json')
  ...
  function chooseRoom(person) {
    switch(person.gender){
      case "female": 
        return`${person.firstname} should use the female change room.`;
        break;
      case "male":
        return `${person.firstname} should use the male change room.`;
        break;
      default:
        return `${person.firstname} should be mindful in choosing a change room.`;
    }
  }
